...
var snowStorm = (function(window, document) {
    ...
    this.animationInterval =
        33; // Theoretical "miliseconds per frame" measurement. 20 = fast + smooth, but high CPU use. 50 = more conservative, but slower
    ...
    this.scrollHandler = function() {
        ...
        scrollY = (storm.flakeBottom
            ? 0
            : parseInt(window.scrollY || document.documentElement.scrollTop || (noFixed ? document.body.scrollTop : 0),
                10));
        if (isNaN(scrollY)) {
    ...
    this.resizeHandler = function() {
        if (window.innerWidth || window.innerHeight) {
            ...
            screenX = (document.documentElement.clientWidth || document.body.clientWidth || document.body.scrollWidth) -
                (!isIE ? 8 : 0) -
    ...
    this.SnowFlake = function(type, x, y) {
        ...
        this.stick = function() {
            if (noFixed ||
                (storm.targetElement !== document.documentElement && storm.targetElement !== document.body)) {
        ...
        this.melt = function() {
            if (!storm.useMeltEffect || !s.melting) {
                ...
                if (s.meltFrame < s.meltFrameCount) {
                    ...
                    s.o.style.lineHeight = storm.flakeHeight +
                        2 +
        ...
        if (window.getComputedStyle) {
            ...
            try {
                targetElementIsRelative =
                    (window.getComputedStyle(storm.targetElement, null).getPropertyValue("position") === "relative");
            } catch (e) {
                // oh well
                targetElementIsRelative = false;
            }
